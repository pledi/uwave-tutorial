...
(function (global, $, jazz, markdown) {
  (function (name, module) {
    ...
    StepDescription.method("positionate", function () {
      ...
      if (dp.dimension.width <= 500) this.dimension.width = dp.dimension.width;
      else this.dimension.width = dp.dimension.width * 0.5;
      //if (dp.dimension.width >= 400) if(dp.dimension.width < 450)this.dimension.width = 420; else this.dimension.width = 700;
      ...
      if (this.dimension.height > dp.dimension.height) {
      ...
      if(dp.dimension.width <= 500) this.$el.css("left", this.position.x);
      else this.$el.css("left", this.position.x - paddingLeftRight);
